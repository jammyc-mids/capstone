...
dark_theme_styles = {
    'background-color': '#222222',#'#343a40',
    'color': '#6c757d',
}
...
#app.head.append(html.Style("""body { background-color: #1f283f; }"""))

app.layout = dbc.Container([
    #dcc.Location(id='url', refresh=False),
    html.Div(id="page-content"),html.Div(className='wrapper', style={'background-color': '#222222'}, children=[
        html.Div(className='content-wrapper', style={'margin-right': '5%', 'margin-left':'5%','margin-bottom':'5%', 'margin-top':'3%', 'background-color': '#222222'}, children=[
            html.H1(id='house-title', style={'textAlign': 'left', 'padding-left':'10px','padding-bottom':'10px', 'background-color': '#222222'}),
            html.Div(className='content', style={'background-color': '#222222'}, children=[
                ...
                html.Div(id='top-graph-container', style={'height': '50vh', 'padding': '10px'}, children=[
                    ...
                    dcc.Graph(id='irradiance-graph', style={'height': '100%'}, config={'displayModeBar': False}, figure={
                        'layout': {
                            'plot_bgcolor': '#222222',#'#343a40',
                                'paper_bgcolor': '#222222',#'#343a40'
                        }
                    })
                ]),
...
ip = get_EC2_public_address('csprod-infra-01')

with open("/home/ubuntu/poc/ip.txt", "w") as file:
    file.write(ip)
...
def update_graphs(n_intervals, start_clicks, pause_clicks, house_id):
    ...
    if start_clicks % 2 == 0:
        ...
        return go.Figure(layout={'plot_bgcolor': '#222222', 'paper_bgcolor': '#222222'}), go.Figure(layout={'plot_bgcolor': '#222222', 'paper_bgcolor': '#222222'})
    ...
    layout = go.Layout(
        ...
        plot_bgcolor='#222222', ##1f283f',#'#343a40',
        paper_bgcolor='#222222',#'#1f283f',#'#343a40',
